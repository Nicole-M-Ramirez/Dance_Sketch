...
//         if (name.includes("shoulder") || name.includes("arm") || name.includes("hand") || name.includes("finger") || name.includes("thumb") || name.includes("index") || name.includes("middle") || name.includes("ring") || name.includes("pinky")) return "upper"
//         if (name.includes("hip") || name.includes("leg") || name.includes("foot") || name.includes("toe")) return "lower"
//         return "other"
//     }
    
//       // Check if a bone belongs to upper body (for fusion)
...
//       // Check if a bone belongs to lower body (for fusion)
...
//         const cachedClip = clipCacheRef.current[upperFbxName]
...
//                 clipCacheRef.current[upperFbxName] = clip

//                 if (shouldShow && activeTask?.upperMove === upperFbxName) {
//                     applyClip(clip)
//                 }
//             },
//             undefined,
...
//             cancelled = true
//         }
//     }, [shouldShow, upperFbxName, activeTask, avatarReady])
...
//             className="fixed bottom-4 left-4 z-50 rounded-lg overflow-hidden shadow-lg border border-gray-700"
//             style={{ width: 320, height: 420, left: (width)*0.8, bottom: "25%" }}
//             aria-label={`Dance animation: ${upperFbxName}`}
//         />
//     )
// }
